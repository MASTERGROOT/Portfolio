export const CONTENT = [
  // Zone 0 — Hero
  {
    ...
    body: {
      ctaLinks: [
        ...
        { type: 'linkedin', label: { en: 'LinkedIn', th: 'LinkedIn' },          href: 'https://www.linkedin.com/in/vivitthachai-laprattanatrai' },
        { type: 'website',  label: { en: 'Portfolio', th: 'พอร์ตโฟลิโอ' },      href: 'https://mastergroot.github.io/Portfolio/' },
      ],
    },
  },
  ...
  // Zone 7 — Contact
  {
    ...
    body: {
      ...
      linkedin: 'https://www.linkedin.com/in/vivitthachai-laprattanatrai',
